...
export function CompactWeekStrip() {
  ...
  return (
    <div className="grid grid-cols-7 rounded-2xl bg-[var(--color-bg-secondary)]/50 px-1 py-2">
      {weekDays.map((day) => {
        ...
        return (
          <button
            ...
            className={cn(
              'flex flex-col items-center gap-1 rounded-xl px-0.5 py-2 transition-colors',
              'active:scale-95',
