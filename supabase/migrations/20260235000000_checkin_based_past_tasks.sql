-- ============================================
-- Fix: Show tasks with check-in records on past dates
--
-- Problem: Past dates show "no tasks" because recurring tasks
-- have start_date after the viewed date (created later).
-- But the user DID check in on those tasks on that date.
--
-- Solution: Add a 5th condition to task scheduling filter:
-- "Show any task that has a check-in on the viewed date"
-- This ensures historical records are always visible.
-- ============================================

-- ============================================
-- 1) get_today_tasks — add check-in based condition
-- ============================================
...
-- ============================================
-- 2) get_week_tasks — add check-in based condition
-- ============================================
