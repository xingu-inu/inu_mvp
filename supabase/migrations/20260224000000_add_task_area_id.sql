-- ============================================
-- Task direct area_id
-- Goal 없이 Area에 직접 태스크를 연결할 수 있게 함
-- 1) Add area_id column to tasks
-- 2) Update get_today_tasks RPC to return directArea
-- 3) Update get_week_tasks RPC to return directArea
-- ============================================

-- ============================================
-- 1) Add area_id column
-- ============================================
...
-- ============================================
-- 2) get_today_tasks — add areaId + directArea
-- ============================================
...
-- ============================================
-- 3) get_week_tasks — add areaId + directArea
-- ============================================
